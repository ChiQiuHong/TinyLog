...
namespace tinylog
{
    ...
    /**
     * LogHandler represents a generic API for processing log messgaes.
     *
     ...
     * additional filtering of message even if the messages were enabled at the
    ...
    public:
         ...
         *
         * @param message The LogMessage object.
        ...
        /**
         * Block until all message that have already been sent to this LogHandler
         * have been processed.
         *
