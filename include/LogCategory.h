...
namespace tinylog
{
    ...
    public:
         ...
         */
        LogCategory(tinylog::StringPiece name, LogCategory *parent);
         ...
         * Log message below this level will be ignored, while messages at or
         * above this level need to be processed by category or one of its
         * parents.
         */
         ...
         * message log level is greater than the LogCategory's effecitve log level.
         *
         ...
         * (Setting inherit to false is necessay if you want a child logCategory to
         ...
         * passed to the parent. You can sest this to any higher log level to prevent
         ...
         *
         * This is used when the LogHandler configuration is changed
         */
    ...
    private:
        ...
        /**
         * Which log message processed at this category should propagate to the
         ...
         * and the user does not want the message duplicated.
         */
         ...
         * inherit its parent's effecitve log level.
         */
         ...
         */
        std::vector<std::shared_ptr<LogHandler>> handlers_; // TODO
         ...
         * LoggerDB::loggerByName_ lock. (These are obly modified when creating new
         ...
         */
        std::vector<std::atomic<LogLevel> *> xlogLevel_;
    };
