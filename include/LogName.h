...
namespace tinylog
{
    ...
    public:
         ...
         * 
         * '/' character is converted to '.', then leading and trailing
         * '.' character are removed, and all sequences of consecutive '.'
         * characters are replaced with a single '.'
         */
        static std::string canonicalize(tinylog::StringPiece input);
         ...
         */
        static size_t hash(tinylog::StringPiece name);

        /**
         * Compare two log names.
         * 
         * The log name does not need to be pre-connoicalized.
         * Return 0 if and only if the two names refer to the same log category.
         * Otherwise, returns -1 if the canonical version of nameA is less than the
         * canonical version of nameB.
         */
        static int cmp(tinylog::StringPiece nameA, tinylog::StringPiece nameB);

        /**
         * Get the name of the parent of log catagory.
         * 
         ...
         */
        static tinylog::StringPiece getParent(tinylog::StringPiece name);
        ...
        struct Hash
        {
            size_t operator()(tinylog::StringPiece key) const
            {
        ...
        struct Equals
        {
            bool operator()(tinylog::StringPiece a, tinylog::StringPiece b) const
            {
