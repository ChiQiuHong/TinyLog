...
{
    EXPECT_EQ(StringPiece(""), LogName::getParent("foo"));
    EXPECT_EQ(StringPiece(""), LogName::getParent(".foo"));
    EXPECT_EQ(StringPiece("foo"), LogName::getParent("foo.bar"));
    EXPECT_EQ(StringPiece("foo"), LogName::getParent("foo/bar"));
    EXPECT_EQ(StringPiece("foo"), LogName::getParent("foo//bar"));
    EXPECT_EQ(StringPiece("foo"), LogName::getParent("foo//bar/"));
    EXPECT_EQ(StringPiece("foo"), LogName::getParent("foo//bar//"));
    EXPECT_EQ(StringPiece("foo..bar"), LogName::getParent("foo..bar..test"));
    EXPECT_EQ(StringPiece("..foo..bar"), LogName::getParent("..foo..bar..test.."));
}
